  ...
  if (isLoading) {
    return (
      <div className="p-4 sm:p-6 md:p-10 w-full pb-20 min-h-screen space-y-6">
        ...
        <div className="block md:hidden bg-white rounded-2xl border border-slate-100 p-4 space-y-4 shadow-sm">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="flex items-center justify-between gap-3 pt-2 first:pt-0">
        ...
        <div className="hidden md:block bg-white rounded-2xl border border-slate-100 p-6 shadow-sm space-y-4">
          {Array.from({ length: 3 }).map((_, i) => (
