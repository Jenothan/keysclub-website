      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          ...
          <p className="text-slate-500 text-body">
            Here are your current bookings and court activities at Point Pedro.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div>
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-500 text-body-sm">Your next court session is scheduled for tomorrow.</p>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-4 border-t border-slate-100 mb-6">
              ...
              <div className="flex items-center gap-3 text-slate-500 text-body-sm">
                ...
                <span className="font-medium">Court 02 (Premium Mat)</span>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-3 bg-white rounded-2xl p-6 border border-slate-100 shadow-sm flex flex-col">
          ...
          <p className="text-slate-500 text-body-sm mb-6 flex-1">
            Find open slots and book a court instantly.
          </p>
      ...
      <div>
        ...
        <div className="space-y-4">
          {history.map((item, index) => (
            ...
            >
              <div>
                <h4 className="font-extrabold text-[#0f172a] text-body mb-1">{item.court}</h4>
